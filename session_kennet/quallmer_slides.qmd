...
subtitle: "Pre-conference Workshop at COMPTEXT 2026"
...
[Slides and tutorials available on Seraphine's QuantLab website: quantilab.github.io](https://quantilab.github.io/)
:::

## About Me

- Professor of Computational Social Science at the School of Social Sciences, Singapore Management University
- Research: text analysis, party competition
- Developer of [quallmer](https://quallmer.github.io/quallmer/index.html) (with Seraphine Maerz)
- Creator of [quanteda](https://quanteda.io)

**Motivation:** Make LLMs tools accessible to qualitative researchers, to replace human content analysts

Website: [kenbenoit.net](https://kenbenoit.net)

My Workshops on instats on [AI-assisted text analysis](https://instats.org/expert/kenneth-benoit-2?view=Seminars)

Seraphine's Workshops on instats on [AI-assisted text analysis and fine-tuning LLMs](https://instats.org/expert/seraphine-maerz-2?view=Seminars)
...
- **Benoit and Laver (2026)**: 

2026. Benoit, Kenneth and Michael Laver. "[Measuring issue salience for political parties using LLMs](https://www.tandfonline.com/doi/full/10.1080/01402382.2026.2637134)." *West European Politics*.  Measuring issue salience from party manifestos with LLMs, using four different scales.

[Using LLMs to analyze political texts through natural language understanding](https://onlinelibrary.wiley.com/doi/10.1111/ajps.70050). *American Journal of Political Science*. LLM-generated party position estimates correlate highly with expert ratings -- scalable alternative to human coders.
...
## "Smart" levels and metrics

**Levels are auto-recognized and recorded**

- Depends on type declaration in schema
- Can be overridden
...
- Application of comparison (inter-coder reliability) and validation metrics is provided automatically, depending on the levels.
- Krippendorff's alpha, for instance, has different forms according to the level of the data
